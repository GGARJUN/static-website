  ...
  return (
    <div className='md:flex justify-between items-center gap-20'>
      ...
      >
        ...
        <h1 className='text-5xl font-bold my-5 '>SunKey Technologies,<span className='bg-[radial-gradient(ellipse_at_right,_var(--tw-gradient-stops))] from-blue-500 via-purple-500 to-red-600 text-transparent bg-clip-text'> Our Mechanical design services</span> </h1>
