    ...
    return (
        <div className='grid grid-cols-12 justify-center items-start gap-10'>
            <div className='max-w-2xl col-span-12 lg:col-span-4'>
                ...
                <p className='text-lg font-medium text-gray-600 tracking-wide mt-14'>Partnering with SunKey Technologies gives you access to a team of skilled <span className="text-blue-600">software engineers</span> who are dedicated to delivering high-quality software solutions. <br /> <br /> We prioritize customer satisfaction and work closely with you to understand your unique requirements. Our expertise in <span className="text-blue-600">software development</span> ensures that your applications are both innovative and reliable.
                </p>
