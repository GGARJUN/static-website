...
const FAQ = () => {
  ...
  return (
    <div >
      <h2 className="text-xl  text-gray-800 flex items-center gap-2" ><div className='w-2 h-2 rounded-full bg-blue-600'></div>FAQ's</h2>
      <div className="flex items-center justify-between">
        <h1 className='text-5xl font-bold my-5 '><span className='bg-[radial-gradient(ellipse_at_right,_var(--tw-gradient-stops))] from-blue-500 via-purple-500 to-red-600 text-transparent bg-clip-text'>Find solutions to common <br /></span>questions</h1>
      ...
      <div className="grid grid-cols-2 items-center gap-40  mt-20">
        <motion.div
          ...
          whileHover={{ scale: 1.05, rotate: 0 }} ref={ref}
          className="2xl:h-[690px] 2xl:w-[700px] h-[250px] w-[200px] rounded-xl shadow-lg object-cover"
        >
          <DirectionAwareHover imageUrl={image1} />
        </motion.div>

        <div className="mt-8 w-[630px]">
