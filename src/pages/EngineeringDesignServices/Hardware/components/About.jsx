  ...
  return (
    <div className='flex justify-between items-center gap-20'>
      <div className='relative'>
        <img src="https://img.freepik.com/free-photo/high-angle-female-technician-with-soldering-iron-electronics-motherboard_23-2148816365.jpg?uid=R110556143&ga=GA1.1.1704431159.1736575258&semt=ais_hybrid" alt="" className='2xl:h-[350px] 2xl:w-[300px] h-[250px] w-[200px] rounded-xl shadow-lg -rotate-12 object-cover' />
        <img src="https://img.freepik.com/free-photo/woman-engineer-architect-working-modern-cad-program-sitting-desk-start-up-business-office_482257-5174.jpg?uid=R110556143&ga=GA1.1.1704431159.1736575258&semt=ais_hybrid" alt="" className='h-[250px] w-[200px] 2xl:h-[350px] 2xl:w-[300px] rounded-xl shadow-lg absolute -bottom-40 2xl:left-60 left-40 rotate-12 object-cover' />
      </div>
