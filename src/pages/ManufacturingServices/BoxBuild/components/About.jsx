...
const About = () => {
  ...
  const image1 = "https://img.freepik.com/free-photo/professional-carpenter-working-with-sawing-machine_1157-35631.jpg?uid=R110556143&ga=GA1.1.1704431159.1736575258&semt=ais_hybrid";
  return (
    <div className='md:flex justify-between items-center gap-20'>
      ...
      >
        ...
        <h1 className='text-5xl font-bold my-5 '>SunKey Technologies,<span className='bg-[radial-gradient(ellipse_at_right,_var(--tw-gradient-stops))] from-blue-500 via-purple-500 to-red-600 text-transparent bg-clip-text'> Our box build services</span> </h1>
