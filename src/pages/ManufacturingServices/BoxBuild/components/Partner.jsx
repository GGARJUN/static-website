    ...
    return (
        <div className='grid grid-cols-12 justify-center items-start gap-10 pb-40'>
            <div className='max-w-2xl col-span-12 lg:col-span-7'>
                ...
                <p className='text-lg font-medium text-gray-600 tracking-wide mt-14'>By partnering with SunKey Technologies, you gain access to a team of skilled engineers and technicians who are dedicated to delivering <span className="text-blue-600">high-quality box build services.</span> We prioritize customer satisfaction and work closely with you to understand your unique requirements. <br /><br /> Our expertise in box build ensures that your products are fully assembled and ready for market.
                </p>
