...
const features = [
  { icon: <Users className="h-12 w-12 text-blue-500" />, img: "/expertise.png", title: "Expertise", description: "Our seasoned professionals excel in engineering, electronics, manufacturing, and IoT solutions.", image: "https://img.freepik.com/free-photo/one-businessman-using-wireless-technology-global-communications-generated-by-ai_188544-20422.jpg" },
  { icon: <Lightbulb className="h-12 w-12 text-blue-500" />, img: "/innovation.png", title: "Innovation", description: "Cutting-edge tech drives our solutions, keeping you at the forefront of progress.", image: "https://img.freepik.com/free-photo/ai-nuclear-energy-background-future-innovation-disruptive-technology_53876-129783.jpg" },
  { icon: <UserCheck className="h-12 w-12 text-blue-500" />, img: "/customer.png", title: "Customer-Centric", description: "Tailored solutions and exceptional support designed around your unique needs.", image: "https://img.freepik.com/free-photo/variety-people-multitasking-3d-cartoon-scene_23-2151294553.jpg?uid=R110556143&ga=GA1.1.1704431159.1736575258&semt=ais_hybrid" },
  { icon: <Shield className="h-12 w-12 text-blue-500" />, img: "/quality.png", title: "Quality Assurance", description: "Uncompromising standards ensure excellence in every project we deliver.", image: "https://img.freepik.com/free-photo/standard-quality-control-collage_23-2149631023.jpg" }
];
