  ...
  const features = [
    {
      ...
      background: (
        <div className="absolute right-0 origin-top rounded-md border transition-all duration-300 ease-out [mask-image:linear-gradient(to_top,transparent_5%,#000_30%)] group-hover:scale-105 w-full">
          <img loading="lazy" src="https://img.freepik.com/free-vector/isometric-gradient-3d-mobile-phone-background_52683-6232.jpg?uid=R110556143&ga=GA1.1.1704431159.1736575258&semt=ais_hybrid" alt="SunKey" className="w-full" />
        </div>
      ),
    },
    {
      ...
      background: (
        <div className="absolute right-0 origin-top rounded-md border transition-all duration-300 ease-out [mask-image:linear-gradient(to_top,transparent_5%,#000_50%)] group-hover:scale-105 w-full">
          <img loading="lazy" src="https://img.freepik.com/free-photo/man-holding-smartphone-with-apartment-buildings-hologram_23-2149369107.jpg?uid=R110556143&ga=GA1.1.1704431159.1736575258&semt=ais_hybrid" alt="SunKey" className="w-full" />
        </div>
      ),
    },
    {
      ...
      background: (
        <div className="absolute right-0 origin-top rounded-md border transition-all duration-300 ease-out [mask-image:linear-gradient(to_top,transparent_5%,#000_60%)] group-hover:scale-105 w-full">
          <img loading="lazy" src="https://img.freepik.com/free-photo/medium-shot-man-kid-relaxing-home_23-2150652853.jpg?uid=R110556143&ga=GA1.1.1704431159.1736575258&semt=ais_hybrid" alt="SunKey" className="w-full" />
        </div>
      ),
    },
    {
      ...
      background: (
        <div className="absolute right-0 origin-top  rounded-md border transition-all duration-300 ease-out group-hover:scale-105">
