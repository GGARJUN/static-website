...
const Banner = () => {
  ...
  return (
    <section className="relative w-full h-screen overflow-hidden">
      ...
      <Button varient="outline" onClick={() => setIsPlaying(!isPlaying)} className="absolute bottom-5 2xl:left-[60%] md:left-[70%] left-[85%] bg-transparent border rounded-md hidden md:block">
      ...
      <div className="absolute bottom-6 w-full text-white flex justify-between items-center px-20">
