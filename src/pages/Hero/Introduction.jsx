...
const Introduction = () => {
  const features = [
    { link: "/", icon: <Users className="h-12 w-12 text-blue-500" />, img: "https://cdn-icons-png.freepik.com/256/17009/17009449.png?uid=R110556143&ga=GA1.1.1704431159.1736575258&semt=ais_hybrid", title: "Engineering Design Service", description: "Sunkey Design Systems a wide range of engineering design services designed to meet the diverse.", image: "/Homepage/Engineering Design Service.jpg" },
    { link: "/", icon: <Lightbulb className="h-12 w-12 text-blue-500" />, img: "https://cdn-icons-png.freepik.com/256/4696/4696145.png?uid=R110556143&ga=GA1.1.1704431159.1736575258&semt=ais_hybrid", title: "Electronic Design", description: "Our electronic design services are designed to help you bring your electronic products to life.", image: "/Homepage/Electronic Design.jpg" },
    { link: "/", icon: <UserCheck className="h-12 w-12 text-blue-500" />, img: "https://cdn-icons-png.freepik.com/256/6008/6008678.png?uid=R110556143&ga=GA1.1.1704431159.1736575258&semt=ais_hybrid", title: "Manufacturing Service", description: "Sunkey Design Systems provides manufacturing services to support product development needs.", image: "/Homepage/Manufacturing.jpg" },
    { link: "/", icon: <Shield className="h-12 w-12 text-blue-500" />, img: "https://cdn-icons-png.freepik.com/256/11296/11296406.png?uid=R110556143&ga=GA1.1.1704431159.1736575258&semt=ais_hybrid", title: "Internet of Things", description: "We specialize in IoT solutions that transform industries and homes.", image: "/Homepage/IOT.jpg" }
  ];
