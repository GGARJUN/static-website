...
const ManufacturingServices = () => {
  ...
  const banners = [
    { img: "/banner1.png", title: "PCBA (Printed Circuit Board Assembly)", subtitle: "Our PCBA services ensure high-quality, reliable circuit boards for your electronic products, with precision and efficiency.", dtitle: "Engineering" },
    { img: "/banner2.jpg", title: "Test Fixtures", subtitle: "We design and build custom test fixtures to ensure your products meet the highest standards of quality and reliability.", dtitle: "Electronic" },
    { img: "/banner3.jpg", title: "Box Build", subtitle: "From components to finished products, our box build services deliver complete assembly solutions for your manufacturing needs.", dtitle: "Manufacturing" },
  ];
              ...
              {banners.map((banner, i) => (
                <div key={i} className="w-full flex-shrink-0 relative rounded-xl">
                  ...
                  <div className="absolute inset-0 flex flex-col justify-center items-start 2xl:px-40 md:px-20 px-10 text-white">
                    <h1 className="text-4xl md:text-5xl 2xl:text-7xl font-medium mb-6">{banner.title}</h1>
