  ...
  return (
    <div>
      ...
      <div>
        ...
        <div className="py-40  bg-gradient-to-r from-pink-300/10 via-purple-100 to-indigo-400/10 ">
          <div className="container mx-auto px-16">
            <Expertise />
          </div>
        </div>
        ...
        <div className="py-40 bg-gradient-to-r from-pink-300/10 via-blue-200 to-indigo-400/10 ">
          <div className="container mx-auto px-16">
            <FAQ />
          </div>
        </div>
