        ...
        <section>
            <div className='md:flex justify-center items-center gap-40 w-full container mx-auto px-16'>
                <div className='flex flex-col gap-5 items-end justify-end'>
                    <div className='md:flex hidden justify-center items-center h-full w-full gap-5'>
                        <Image src="https://img.freepik.com/free-photo/happy-motivated-colleagues-office_114579-2790.jpg?uid=R110556143&ga=GA1.1.1704431159.1736575258&semt=ais_hybrid" alt="" width={350} height={200} className='' />
                        <Image src="https://img.freepik.com/free-photo/creative-businessmen-with-drawn-bulbs_1134-663.jpg?uid=R110556143&ga=GA1.1.1704431159.1736575258&semt=ais_hybrid" alt="" width={400} height={200} className='' />
                    </div>
                    <div className=' '>
                        <Image src="https://img.freepik.com/free-photo/group-diverse-business-people_53876-20967.jpg?uid=R110556143&ga=GA1.1.1704431159.1736575258&semt=ais_hybrid" alt="" className=' object-cover  ' width={550} height={200} />
                    </div>
                </div>
