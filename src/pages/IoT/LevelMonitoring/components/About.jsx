...
const About = () => {
  ...
  const image1 = "https://img.freepik.com/free-photo/futuristic-control-panel_23-2151957130.jpg?uid=R110556143&ga=GA1.1.1704431159.1736575258&semt=ais_hybrid";
  const image2 = "https://img.freepik.com/free-photo/working-process-polygraph-examiner-office-with-his-lie-detector-s-equipment_146671-17304.jpg?uid=R110556143&ga=GA1.1.1704431159.1736575258&semt=ais_hybrid";
  return (
    <div className='flex justify-between items-center gap-20'>
      <div ref={ref} className="relative md:block hidden">
        <motion.div
      ...
      >
        ...
        <h1 className='text-5xl font-bold my-5 '><span className='bg-[radial-gradient(ellipse_at_right,_var(--tw-gradient-stops))] from-blue-500 via-purple-500 to-red-600 text-transparent bg-clip-text'>SunKey Technologies,</span> Our Level Monitoring services </h1>
        <p className='text-lg font-medium text-gray-600 tracking-wide'>At SunKey Technologies,<span className='text-blue-600 font-semibold'>Our Level Monitoring services </span>   focus on providing IoT-based solutions for monitoring levels in various applications, such as tanks, silos, and containers. <br /><br /> Our team of experts integrates sensors and IoT technology to ensure accurate and real-time level monitoring, enhancing operational efficiency and safety.
        </p>
