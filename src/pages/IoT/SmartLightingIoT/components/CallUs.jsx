...
const CallUs = () => {
  return (
    ...
    <div
      className="relative bg-[url('https://img.freepik.com/free-photo/close-up-hand-touching-virtual-assistant_23-2148994210.jpg?uid=R110556143&ga=GA1.1.1704431159.1736575258&semt=ais_hybrid')] bg-cover bg-fixed bg-center mt-40 h-[900px] flex items-center justify-center"
    >
