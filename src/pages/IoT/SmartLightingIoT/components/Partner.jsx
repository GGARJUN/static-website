...
const Partner = () => {
    const imageUrl = "https://img.freepik.com/premium-photo/person-using-mobile-app-adjust-smart-home-devices_853812-8312.jpg?uid=R110556143&ga=GA1.1.1704431159.1736575258&semt=ais_hybrid";
    return (
        <div className='grid grid-cols-12 justify-center items-start gap-10'>
            <div className='max-w-2xl col-span-12 lg:col-span-7'>
                ...
                <p className='text-lg font-medium text-gray-600 tracking-wide mt-14'>Partnering with SunKey Technologies gives you access to a team of skilled engineers who are dedicated to delivering <span className="text-blue-600">high-quality Smart Lighting IoT solutions.</span> We prioritize customer satisfaction and work closely with you to understand your unique requirements.<br /><br /> Our expertise in  <span className="text-blue-600">Smart Lighting IoT</span> ensures that your lighting systems are both efficient and effective.
                </p>
