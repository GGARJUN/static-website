...
const About = () => {
  ...
  const image1 = "https://img.freepik.com/free-photo/young-woman-wearing-embroidered-shirt_23-2149394271.jpg?uid=R110556143&ga=GA1.1.1704431159.1736575258&semt=ais_hybrid";
  const image2 = "https://img.freepik.com/free-photo/view-futuristic-light-lamp-design_23-2151037524.jpg?uid=R110556143&ga=GA1.1.1704431159.1736575258&semt=ais_hybrid";
  return (
    <div className='flex justify-between items-center gap-20'>
      ...
      >
        ...
        <h1 className='text-5xl font-bold my-5 '><span className='bg-[radial-gradient(ellipse_at_right,_var(--tw-gradient-stops))] from-blue-500 via-purple-500 to-red-600 text-transparent bg-clip-text'>SunKey Technologies,</span> Our Smart Lighting IoT services</h1>
        <p className='text-lg font-medium text-gray-600 tracking-wide'>At SunKey Technologies,<span className='text-blue-600 font-semibold'>Our Smart Lighting IoT services</span>   focus on developing intelligent lighting systems that enhance ambiance, energy efficiency, and safety. <br /><br /> Our team of experts integrates IoT technology into lighting systems to optimize brightness, color, and energy usage based on occupancy and ambient conditions.
        </p>
