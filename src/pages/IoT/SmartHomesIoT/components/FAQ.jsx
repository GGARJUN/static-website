...
const FAQ = () => {
  ...
  const faqItems = [
    {
      question: "1. What types of smart home systems do you integrate?",
      answer:
        "We integrate lighting, temperature, security, and entertainment systems.",
    },
    {
      question: "2. Can you help with smart lighting systems?",
      answer:
        "Yes, we develop intelligent lighting systems that adjust based on occupancy and ambient light.",
    },
    {
      question: "3. Do you provide energy efficiency solutions?",
      answer:
        "Yes, we implement solutions to reduce energy consumption and optimize resource usage.",
    },
    {
      question: "4. How do you enhance home automation?",
      answer:
        "We integrate systems for seamless control of home devices.",
    },
    {
      question: "5. Do you offer remote monitoring and control services?",
      answer:
        "Yes, we enable remote access to home systems for enhanced convenience and security.",
    },
  ];
  return (
    <>
