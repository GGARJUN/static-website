...
const Partner = () => {
    const imageUrl = "https://img.freepik.com/free-photo/successful-smart-caucasian-businessman-walking-stair-trade-stock-with-smartphone-communicate-with-happiness-enthusiastic-modern-office-background_609648-953.jpg?uid=R110556143&ga=GA1.1.1704431159.1736575258&semt=ais_hybrid";
    return (
        <div className='grid grid-cols-12 justify-center items-start gap-10'>
            <div className='max-w-2xl col-span-12 lg:col-span-7'>
                ...
                <p className='text-lg font-medium text-gray-600 tracking-wide mt-14'>By partnering with SunKey Technologies, you gain access to a team of skilled engineers who are dedicated to delivering <span className="text-blue-600">high-quality Smart Homes IoT solutions.</span> We prioritize customer satisfaction and work closely with you to understand your unique requirements.<br /><br /> Our expertise in  <span className="text-blue-600">Smart Homes IoT</span> ensures that your living space is both comfortable and efficient.
