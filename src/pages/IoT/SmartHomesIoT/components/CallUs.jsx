...
const CallUs = () => {
  return (
    ...
    <div
      className="relative bg-[url('https://img.freepik.com/free-photo/man-recording-studio-music-production_1303-20398.jpg?uid=R110556143&ga=GA1.1.1704431159.1736575258&semt=ais_hybrid')] bg-cover bg-fixed bg-center mt-40 h-[900px] flex items-center justify-center"
    >
