...
const About = () => {
  ...
  const image1 = "https://img.freepik.com/free-photo/neon-robot-vacuum-cleaner_23-2151349241.jpg?uid=R110556143&ga=GA1.1.1704431159.1736575258&semt=ais_hybrid";
  const image2 = "https://img.freepik.com/free-photo/person-choosing-where-they-work-from-hybrid-working-model_23-2149483823.jpg?uid=R110556143&ga=GA1.1.1704431159.1736575258&semt=ais_hybrid";
  return (
    <div className='flex justify-between items-center gap-20'>
      ...
      >
        ...
        <h1 className='text-5xl font-bold my-5 '><span className='bg-[radial-gradient(ellipse_at_right,_var(--tw-gradient-stops))] from-blue-500 via-purple-500 to-red-600 text-transparent bg-clip-text'>SunKey Technologies,</span> Our Smart Homes IoT services</h1>
        <p className='text-lg font-medium text-gray-600 tracking-wide'>At SunKey Technologies,<span className='text-blue-600 font-semibold'>Our Smart Homes IoT services</span>  focus on creating intelligent living spaces that enhance comfort, convenience, and energy efficiency. <br /><br /> We integrate IoT technology into home systems to control <span className='text-red-600'>lighting, temperature, security,</span> and entertainment systems remotely.
