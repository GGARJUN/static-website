    ...
    <div>
      ...
      <div className='grid grid-cols-12 mt-24 gap-10  '>
        <div className='relative  col-span-4'>
          <img src="https://img.freepik.com/free-photo/close-up-hands-using-mouse_23-2148994173.jpg?uid=R110556143&ga=GA1.1.1704431159.1736575258&semt=ais_hybrid" alt="" className=' w-[] rounded-xl  object-cover shadow-xl h-full' />
