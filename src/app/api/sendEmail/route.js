...
export async function POST(request) {
  try {
    ...
    const mailOptions = {
      ...
      //   to: ["v.jain@sunkeydesignsystems.com", "kumar@sunkeydesignsystems.com"], 
      ...
      <div style="font-family: Arial, sans-serif; color: #333; max-width: 600px; margin: 0 auto; border: 1px solid #ddd; border-radius: 8px; overflow: hidden;">
        ...
        <div style="padding: 20px;">
          ...
          <div style="text-align: center; margin-top: 30px;">
            <a href="https://yourdomain.com/contact" style="background-color: #007BFF; color: #fff; padding: 10px 20px; text-decoration: none; border-radius: 5px; font-size: 16px;">
              View Full Details
            </a>
          </div>
        </div>
