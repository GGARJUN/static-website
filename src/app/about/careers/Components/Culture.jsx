...
const Culture = () => {
  const features = [
    { link: "/", img: "https://cdn-icons-png.freepik.com/256/1087/1087815.png?uid=R110556143&ga=GA1.1.1704431159.1736575258&semt=ais_hybrid", title: "Innovation", description: "Using sensors to predict equipment failures and reduce downtime." },
    { link: "/", img: "https://cdn-icons-png.freepik.com/256/816/816376.png?uid=R110556143&ga=GA1.1.1704431159.1736575258&semt=ais_hybrid", title: "Meritocracy & Motivation", description: "Providing real-time data on production processes to optimize workflows." },
    { link: "/", img: "https://cdn-icons-png.freepik.com/256/14373/14373389.png?uid=R110556143&ga=GA1.1.1704431159.1736575258&semt=ais_hybrid", title: "Accountability", description: "Automating tasks with smart machines and sensors to improve accuracy and efficiency.", },
    { link: "/", img: "https://cdn-icons-png.freepik.com/256/537/537051.png?uid=R110556143&ga=GA1.1.1704431159.1736575258&semt=ais_hybrid", title: "Client Focus", description: "Tracking assets in real-time to improve logistics and supply chain management.", },
    { link: "/", img: "https://cdn-icons-png.freepik.com/256/5526/5526430.png?uid=R110556143&ga=GA1.1.1704431159.1736575258&semt=ais_hybrid", title: "Respect", description: "Enabling remote monitoring and control of industrial equipment for enhanced safety and efficiency.", },
  ];
  return (
    <div>
      {/* Heading Section */}
