...
const Expertise = () => {
  ...
  return (
    <div className='md:flex  justify-between items-center gap-10 '>
      ...
      <div className="relative w-full flex justify-end items-center mt-10 md:mt-0">
        <div className="relative md:w-[400px] md:h-[550px] w-full h-[500px]">
          <img
        ...
        {/* Foreground Image */}
        <div className="absolute left-40 top-10 md:w-[300px] md:h-[400px] border-4 border-white shadow-lg md:block hidden">
          <img
