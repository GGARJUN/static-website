...
const FAQ = () => {
  ...
  const faqItems = [
    {
      question: "What types of products do you assemble?",
      answer:
        "We assemble a wide range of electronic products, from simple devices to complex systems.",
    },
    {
      question: "Can you handle cable and harness assembly?",
      answer:
        "Yes, we create custom cables and harnesses for product connectivity.",
    },
    {
      question: "Do you provide final product packaging?",
      answer:
        "Yes, we prepare products for safe transportation and storage.",
    },
    {
      question: "How do you ensure quality control in box build?",
      answer:
        "We conduct rigorous inspections and testing to ensure high-quality assemblies.",
    },
    {
      question: "Do you offer customization options for box build services?",
      answer:
        "Yes, we tailor our box build services to meet your specific product needs.",
    },
  ];
  return (
    <>
