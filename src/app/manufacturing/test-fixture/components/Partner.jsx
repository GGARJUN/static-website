...
const Partner = () => {
  const imageUrl =
    "https://img.freepik.com/free-vector/software-integration-concept-illustration_114360-7447.jpg?uid=R110556143&ga=GA1.1.1704431159.1736575258&semt=ais_hybrid";
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-10  pb-20 ">
      ...
      <div className="max-w-2xl col-span-1 lg:col-span-7">
        ...
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold my-5">
        ...
        <p className="text-base sm:text-lg font-medium text-gray-600 tracking-wide mt-6 md:mt-14">
          By partnering with Sunkey Design Systems, you gain access to a team of
          skilled engineers who are dedicated to delivering{" "}
          <span className="text-blue-600">high-quality test fixtures.</span> We
          prioritize customer satisfaction and work closely with you to
          understand your unique requirements. <br />
          <br /> Our expertise in{" "}
          <span className="text-blue-600">test fixture design and manufacturing</span>{" "}
          ensures that your products are thoroughly tested and validated.
        </p>
