...
const Expertise = () => {
  ...
  return (
      ...
      <div className='container mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        <h1 className='text-5xl font-bold my-5 max-w-4xl'><span className='bg-[radial-gradient(ellipse_at_right,_var(--tw-gradient-stops))] from-blue-500 via-purple-500 to-red-600 text-transparent bg-clip-text'>Our PCBA </span>design expertise</h1>
      </div>
