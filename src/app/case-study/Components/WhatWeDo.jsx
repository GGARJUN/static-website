        ...
        <section>
            <div className='lg:flex justify-center items-center gap-40 w-full container mx-auto px-4 sm:px-6 lg:px-8'>
                <div className='flex flex-col gap-5 items-end justify-end mb-20 lg:mb-0'>
                    <Image src="https://img.freepik.com/free-photo/happy-motivated-colleagues-office_114579-2790.jpg?uid=R110556143&ga=GA1.1.1704431159.1736575258&semt=ais_hybrid" alt="" width={400} height={400} className='rounded-xl shadow-xl w-full h-auto' />
                </div>
