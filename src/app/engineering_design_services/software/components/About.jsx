  ...
  return (
    <div className='flex justify-between items-center gap-20'>
      ...
      >
        ...
        <h1 className='text-5xl font-bold my-5 '><span className='bg-[radial-gradient(ellipse_at_right,_var(--tw-gradient-stops))] from-blue-500 via-purple-500 to-red-600 text-transparent bg-clip-text'>SunKey Technologies,</span> our Software design services</h1>
      ...
      <div ref={ref} className="relative items-center justify-center md:block hidden">
        <motion.div
          ...
          className="absolute 2xl:-top-20 right-40 2xl:h-[350px] 2xl:w-[300px] h-[250px] w-[200px] rounded-xl shadow-lg object-cover"
        >
        ...
        <motion.div
          ...
          whileHover={{ scale: 1.05, rotate: 10 }}
          className="absolute -bottom-20 md:-left-60 left-40 2xl:h-[350px] 2xl:w-[300px] h-[250px] w-[200px] rounded-xl shadow-lg object-cover"
        >
