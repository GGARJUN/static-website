    ...
    <div className='flex flex-col lg:flex-row items-center justify-between gap-12'>
      ...
      >
        ...
        <h2 className='title-all my-4 text-2xl sm:text-3xl lg:text-4xl'>
          ...
          </span> Our Mechanical design services
        </h2>
        <p className='para-all text-sm sm:text-base'>
          <span className='text-blue-600 font-semibold'>At Sunkey Design Systems,</span> Our mechanical design services focus on providing mechanical design solutions that integrate seamlessly with electronic systems.
          <br /><br /> 
          Our team of experienced mechanical engineers works closely with you to develop designs that meet your specific needs, from conceptualization to prototyping. 
        </p>
