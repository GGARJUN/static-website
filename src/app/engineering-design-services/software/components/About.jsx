      ...
      <div className='flex flex-col lg:flex-row-reverse items-center justify-between gap-12'>
        ...
        >
          ...
          <h2 className='title-all my-4 text-2xl sm:text-3xl lg:text-4xl'>
            ...
            </span> our Software design services
          </h2>
          <p className='para-all text-sm sm:text-base'>
            <span className='text-blue-600 font-semibold'>At Sunkey Design Systems, our software design services</span> focus on creating software applications that enhance user experience and efficiency.
            <br /><br />
            Our team of skilled software engineers works closely with you to develop software solutions that meet your specific needs, from conceptualization to deployment.
          </p>
