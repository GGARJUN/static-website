...
const Partner = () => {
    const imageUrl = "https://img.freepik.com/free-photo/male-female-graphic-designers-interacting-computer_1170-938.jpg?uid=R110556143&ga=GA1.1.1704431159.1736575258&semt=ais_hybrid";
    return (
        <div className='grid grid-cols-12 justify-center items-start gap-10'>
            <div className='max-w-2xl col-span-12 lg:col-span-4'>
                ...
                <p className='text-lg font-medium text-gray-600 tracking-wide mt-14'>Partnering with Sunkey Design Systems gives you access to a team of skilled <span className="text-blue-600">software engineers</span> who are dedicated to delivering high-quality software solutions. <br /> <br /> We prioritize customer satisfaction and work closely with you to understand your unique requirements. Our expertise in <span className="text-blue-600">software development</span> ensures that your applications are both innovative and reliable.
                </p>
            ...
            <div className='col-span-12 lg:col-span-4 w-full mt-5'>
                ...
                <p className='text-lg font-medium text-gray-600 tracking-wide mt-8'>We prioritize customer satisfaction and work closely with you to understand your unique requirements. Our expertise in <span className="text-blue-600">software development</span> ensures that your applications are both innovative and reliable.
                </p>
