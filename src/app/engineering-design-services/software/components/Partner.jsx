        ...
        <div className=''>
            <div className='flex flex-col lg:flex-row justify-center items-start gap-8'>
                ...
                <div className='w-full max-w-lg lg:max-w-2xl lg:flex-1'>
                    ...
                    <h2 className='text-3xl sm:text-4xl lg:text-5xl font-bold my-4 sm:my-5'>
                    ...
                    <p className='text-base sm:text-lg font-medium text-gray-600 tracking-wide mt-8 sm:mt-14'>
                        Partnering with Sunkey Design Systems gives you access to a team of skilled 
                        <span className="text-blue-600"> software engineers</span> who are dedicated to delivering high-quality software solutions. 
                        <br /> <br /> 
                        We prioritize customer satisfaction and work closely with you to understand your unique requirements. Our expertise in 
                        <span className="text-blue-600"> software development</span> ensures that your applications are both innovative and reliable.
                    </p>
                ...
                {/* Stats Section */}
                <div className='w-full max-w-lg lg:max-w-md lg:flex-1 mt-8 lg:mt-0'>
                    <h2 className='text-xl sm:text-2xl text-gray-900 font-bold'>
