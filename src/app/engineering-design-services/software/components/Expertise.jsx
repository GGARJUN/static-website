        ...
        `}
              >
                ...
                <img loading='lazy'
                  ...
                  />
                  <h3 className="line-clamp-1 2xl:line-clamp-none text-gray-900 2xl:text-2xl text-xl font-bold mb-3 group-hover:-translate-y-3 transition-all duration-300 group-hover:text-white">
                    {item.title}
                  </h3>
