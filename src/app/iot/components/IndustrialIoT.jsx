  ...
  return (
    <div>
      <div className='flex flex-col justify-center items-start '>
        <h2 className="text-xl   text-gray-800 flex items-center  gap-2" ><div className='w-2 h-2 rounded-full bg-blue-600'></div>Industrial Internet of Things</h2>
        <h2 className='mt-8 title-all bg-gradient-to-r from-purple-500  to-pink-500 text-transparent bg-clip-text'>Transforming Industries with Smart Solutions</h2>
        <p className='   2xl:px-32 mt-5'>We implement IoT technologies to enhance industrial efficiency and productivity. Our solutions include:
        </p>
        ...
        <div className='relative mt-20'>
          <Image priority width={1200} height={600} src="https://img.freepik.com/free-photo/portrait-engineers-work-hours-job-site_23-2151589617.jpg?uid=R110556143&ga=GA1.1.1704431159.1736575258&semt=ais_hybrid" alt="industrial-iot" className=' w-[1100px] rounded-3xl h-96  object-cover shadow-xl' />
