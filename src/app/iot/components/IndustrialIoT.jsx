    ...
    <div>
      <div className='flex flex-col justify-center items-start '>
        ...
        <div className='relative mt-20'>
          <img loading='lazy' src="https://img.freepik.com/free-photo/portrait-engineers-work-hours-job-site_23-2151589617.jpg?uid=R110556143&ga=GA1.1.1704431159.1736575258&semt=ais_hybrid" alt="industrial-iot" className=' w-[1100px] rounded-3xl h-96  object-cover shadow-xl' />
