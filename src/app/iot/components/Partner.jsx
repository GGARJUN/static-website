            ...
            <div className='flex flex-col lg:flex-row justify-center items-start gap-8'>
                ...
                <div className='w-full max-w-lg lg:max-w-2xl lg:flex-1'>
                    ...
                    <p className='text-base sm:text-lg font-medium text-gray-600 tracking-wide mt-8 sm:mt-14'>
                        ...
                        <span className="text-blue-600"> high-quality IoT solutions.</span> We prioritize customer satisfaction and work closely with you to understand your unique requirements.
                        <br /><br /> 
                        Our expertise in <span className="text-blue-600"> IoT</span> ensures that your operations are streamlined, efficient, and well-managed. We leverage the latest technologies to provide secure, scalable, and reliable IoT solutions that drive business value.
                    </p>
