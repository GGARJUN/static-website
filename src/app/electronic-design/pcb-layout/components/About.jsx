...
const About = () => {
  ...
  const image1 = "https://img.freepik.com/free-photo/portrait-person-doing-arts-crafts_23-2151575715.jpg?uid=R110556143&ga=GA1.1.1704431159.1736575258&semt=ais_hybrid";
  return (
    <div className='lg:flex lg:justify-between justify-center items-center gap-20 '>
      ...
      >
        ...
        <p className='text-lg font-medium text-gray-600 tracking-wide'>At Sunkey Design Systems,<span className='text-blue-600 font-semibold'>Our PCB design services</span>  are designed to help you create innovative electronic products. Our team of experienced engineers uses the latest CAD software to ensure that your PCB designs are both functional and efficient. <br /><br /> From conceptualization to prototyping, we guide you through every step of the design process.</p>
        ...
        <div className='md:flex items-center justify-between  mt-10'>
          <div className='flex items-center justify-between'>
            <h2 className='text-7xl font-black bg-[radial-gradient(ellipse_at_right,_var(--tw-gradient-stops))] from-indigo-500 via-red-500 to-blue-500 text-transparent bg-clip-text'>25+</h2>
