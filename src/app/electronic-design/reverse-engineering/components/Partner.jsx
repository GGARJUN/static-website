            ...
            <div className='flex flex-col lg:flex-row justify-center items-start gap-8'>
                ...
                <div className='w-full max-w-lg lg:max-w-2xl lg:flex-1'>
                    ...
                    <p className='text-base sm:text-lg font-medium text-gray-600 tracking-wide mt-8 sm:mt-14'>
                        By partnering with Sunkey Design Systems, you gain access to a team of skilled engineers who are dedicated to delivering high-quality reverse engineering services. We prioritize customer satisfaction and work closely with you to understand your unique requirements.
                        <br /><br />
                        Our expertise in reverse engineering ensures that you can improve or replicate existing products efficiently.
                    </p>
