    ...
    return (
        <div className='grid grid-cols-12 justify-center items-start gap-10'>
            <div className='max-w-2xl col-span-12 lg:col-span-7'>
                ...
                <p className='text-lg font-medium text-gray-600 tracking-wide mt-14'>By partnering with Sunkey Design Systems, you gain access to a team of skilled engineers who are dedicated to delivering high-quality reverse engineering services. We prioritize customer satisfaction and work closely with you to understand your unique requirements. <br /><br /> Our expertise in reverse engineering ensures that you can improve or replicate existing products efficiently.
