      ...
      <div className='flex flex-col lg:flex-row items-center justify-between gap-12'>
        ...
        >
          ...
          <p className='text-base sm:text-lg font-medium text-gray-600 tracking-wide'>
            ...
            <span className='text-blue-600 font-semibold'> Our Reverse Engineering services</span> focus on analyzing existing electronic products to improve or replicate them. 
            <br /><br /> 
            Our team of skilled engineers works closely with you to understand your requirements and deliver high-quality reverse engineering solutions.
          </p>
