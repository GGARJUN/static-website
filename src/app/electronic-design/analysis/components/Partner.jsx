            ...
            <div className='flex flex-col lg:flex-row justify-center items-start gap-8 w-full'>
                ...
                <div className='w-full lg:flex-1'>
                    ...
                    <p className='text-base sm:text-lg font-medium text-gray-600 tracking-wide mt-8 sm:mt-14'>
                        ...
                        <span className="text-blue-600">high-quality SI/PI analysis services.</span> We prioritize customer satisfaction and work closely with you to understand your unique requirements.
                        <br /><br /> 
                        Our expertise in <span className="text-blue-600">SI/PI analysis</span> ensures that your PCBs operate efficiently and reliably.
                    </p>
                ...
                {/* Image Section */}
                <div className="w-full h-[400px] sm:h-[500px] lg:h-[630px] rounded-xl shadow-lg relative flex items-center justify-center lg:flex-1">
