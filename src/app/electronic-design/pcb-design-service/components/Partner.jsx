            ...
            <div className='flex flex-col lg:flex-row justify-center items-start gap-8'>
                ...
                <div className='w-full max-w-lg lg:max-w-2xl lg:flex-1'>
                    ...
                    <p className='text-base sm:text-lg font-medium text-gray-600 tracking-wide mt-8 sm:mt-14'>
                        Partnering with Sunkey Design Systems gives you access to a team of skilled engineers and technicians who are dedicated to delivering
                        <span className="text-blue-600"> high-quality PCB services.</span> We prioritize customer satisfaction and work closely with you to understand your unique requirements.
                        <br /><br />
                        Our expertise in PCBs ensures that your products are both innovative and reliable.
                    </p>
