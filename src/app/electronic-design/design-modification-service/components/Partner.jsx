    ...
    return (
        <div className='grid grid-cols-12 justify-center items-start gap-10'>
            <div className='max-w-2xl col-span-12 lg:col-span-7'>
                ...
                <p className='text-lg font-medium text-gray-600 tracking-wide mt-14'>Partnering with SunKey Technologies gives you access to a team of skilled engineers who are dedicated to delivering <span className="text-blue-600"> high-quality design modification services.</span> We prioritize customer satisfaction and work closely with you to understand your unique requirements.<br /><br /> Our expertise in  <span className="text-blue-600">design modification</span> ensures that your products remain competitive and efficient.
                </p>
